...
export type PastLaunchesListQueryVariables = Exact<{ [key: string]: never; }>;


export type PastLaunchesListQuery = { __typename?: 'Query', launchesPast?: Array<{ __typename?: 'Launch', mission_name?: string | null | undefined, launch_date_local?: any | null | undefined, id?: string | null | undefined, launch_site?: { __typename?: 'LaunchSite', site_name_long?: string | null | undefined } | null | undefined, links?: { __typename?: 'LaunchLinks', article_link?: string | null | undefined, flickr_images?: Array<string | null | undefined> | null | undefined } | null | undefined } | null | undefined> | null | undefined };

export type RocketsListQueryVariables = Exact<{ [key: string]: never; }>;


export type RocketsListQuery = { __typename?: 'Query', rockets?: Array<{ __typename?: 'Rocket', company?: string | null | undefined, description?: string | null | undefined, wikipedia?: string | null | undefined, id?: string | null | undefined } | null | undefined> | null | undefined };

export type UpcomingLaunchesListQueryVariables = Exact<{ [key: string]: never; }>;


export type UpcomingLaunchesListQuery = { __typename?: 'Query', launchesUpcoming?: Array<{ __typename?: 'Launch', details?: string | null | undefined, launch_date_local?: any | null | undefined, id?: string | null | undefined, mission_name?: string | null | undefined, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined };
...
export const UpcomingLaunchesListDocument = gql`
...
/**
 * __useUpcomingLaunchesListQuery__
 *
 * To run a query within a React component, call `useUpcomingLaunchesListQuery` and pass it any options that fit your needs.
 * When your component renders, `useUpcomingLaunchesListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useUpcomingLaunchesListQuery({
 *   variables: {
 *   },
 * });
 */
export function useUpcomingLaunchesListQuery(baseOptions?: Apollo.QueryHookOptions<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>(UpcomingLaunchesListDocument, options);
      }
export function useUpcomingLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>(UpcomingLaunchesListDocument, options);
        }
export type UpcomingLaunchesListQueryHookResult = ReturnType<typeof useUpcomingLaunchesListQuery>;
export type UpcomingLaunchesListLazyQueryHookResult = ReturnType<typeof useUpcomingLaunchesListLazyQuery>;
export type UpcomingLaunchesListQueryResult = Apollo.QueryResult<UpcomingLaunchesListQuery, UpcomingLaunchesListQueryVariables>;